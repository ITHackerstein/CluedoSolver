...
public:
	...
	friend bool operator==(engine<xtype1, itype1, output_mixin1, output_previous1, stream_mixin_lhs, multiplier_mixin_lhs> const&, engine<xtype1, itype1, output_mixin1, output_previous1, stream_mixin_rhs, multiplier_mixin_rhs> const&);

	template<typename xtype1, typename itype1, typename output_mixin1, bool output_previous1, typename stream_mixin_lhs, typename multiplier_mixin_lhs, typename stream_mixin_rhs, typename multiplier_mixin_rhs>
	friend itype1 operator-(engine<xtype1, itype1, output_mixin1, output_previous1, stream_mixin_lhs, multiplier_mixin_lhs> const&, engine<xtype1, itype1, output_mixin1, output_previous1, stream_mixin_rhs, multiplier_mixin_rhs> const&);
	...
	operator<<(std::basic_ostream<CharT, Traits>& out, engine<xtype1, itype1, output_mixin1, output_previous1, stream_mixin1, multiplier_mixin1> const&);
...
operator<<(std::basic_ostream<CharT, Traits>& out, engine<xtype, itype, output_mixin, output_previous, stream_mixin, multiplier_mixin> const& rng) {
...
itype operator-(engine<xtype, itype, output_mixin, output_previous, stream_mixin_lhs, multiplier_mixin_lhs> const& lhs, engine<xtype, itype, output_mixin, output_previous, stream_mixin_rhs, multiplier_mixin_rhs> const& rhs) {
...
template<typename xtype, typename itype, typename output_mixin, bool output_previous, typename stream_mixin_lhs, typename multiplier_mixin_lhs, typename stream_mixin_rhs, typename multiplier_mixin_rhs>
bool operator==(engine<xtype, itype, output_mixin, output_previous, stream_mixin_lhs, multiplier_mixin_lhs> const& lhs, engine<xtype, itype, output_mixin, output_previous, stream_mixin_rhs, multiplier_mixin_rhs> const& rhs) {
...
template<typename xtype, typename itype, typename output_mixin, bool output_previous, typename stream_mixin_lhs, typename multiplier_mixin_lhs, typename stream_mixin_rhs, typename multiplier_mixin_rhs>
inline bool operator!=(engine<xtype, itype, output_mixin, output_previous, stream_mixin_lhs, multiplier_mixin_lhs> const& lhs, engine<xtype, itype, output_mixin, output_previous, stream_mixin_rhs, multiplier_mixin_rhs> const& rhs) {
...
struct inside_out : private baseclass {
	...
	static bool external_advance(result_type& randval, size_t i, result_type delta, bool forwards = true) {
		...
		bool crosses_zero = forwards ? dist_to_zero <= delta
		                             : (-dist_to_zero) <= delta;
		if (!forwards)
			delta = -delta;
...
private:
	...
	static constexpr state_type tick_mask = may_tick ? state_type(
...
public:
	...
	extended(result_type const* data)
	  : baseclass() {
		datainit(data);
	}

	extended(result_type const* data, state_type seed)
	  : baseclass(seed) {
		datainit(data);
	}
	...
	extended(result_type const* data, state_type seed, typename bc::stream_state stream_seed)
...
private:
	void selfinit();
	void datainit(result_type const* data);
...
public:
	...
	friend bool operator==(extended<table_pow2_, advance_pow2_, baseclass_, extvalclass_, kdd_> const&, extended<table_pow2_, advance_pow2_, baseclass_, extvalclass_, kdd_> const&);
	...
	friend std::basic_ostream<CharT, Traits>&
	operator<<(std::basic_ostream<CharT, Traits>& out, extended<table_pow2_, advance_pow2_, baseclass_, extvalclass_, kdd_> const&);
...
template<bitcount_t table_pow2, bitcount_t advance_pow2, typename baseclass, typename extvalclass, bool kdd>
bool operator==(extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd> const& lhs, extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd> const& rhs) {
	auto& base_lhs = static_cast<baseclass const&>(lhs);
	auto& base_rhs = static_cast<baseclass const&>(rhs);
	return base_lhs == base_rhs
	  && !memcmp((void*)lhs.data_, (void*)rhs.data_, sizeof(lhs.data_));
}

template<bitcount_t table_pow2, bitcount_t advance_pow2, typename baseclass, typename extvalclass, bool kdd>
inline bool operator!=(extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd> const& lhs, extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd> const& rhs) {
	return lhs != rhs;
}
...
std::basic_ostream<CharT, Traits>&
operator<<(std::basic_ostream<CharT, Traits>& out, extended<table_pow2, advance_pow2, baseclass, extvalclass, kdd> const& rng) {
	auto orig_flags = out.flags(std::ios_base::dec | std::ios_base::left);
	auto space = out.widen(' ');
	auto orig_fill = out.fill();
	...
	for (auto const& datum : rng.data_)
		out << space << datum;
