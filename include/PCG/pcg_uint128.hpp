...
public:
	...
	typedef typename std::conditional<std::is_same<uint64_t, unsigned long>::value, unsigned long long, unsigned long>::type
	  uint_missing_t;
	...
	friend uint_x4<U, V> operator*(uint_x4<U, V> const&, uint_x4<U, V> const&);

	template<typename U, typename V>
	friend std::pair<uint_x4<U, V>, uint_x4<U, V>>
	divmod(uint_x4<U, V> const&, uint_x4<U, V> const&);
	...
	template<typename U, typename V>
	friend bool operator==(uint_x4<U, V> const&, uint_x4<U, V> const&);
	...
	template<typename U, typename V>
	friend uint_x4<U, V> operator~(uint_x4<U, V> const&);

	template<typename U, typename V>
	friend uint_x4<U, V> operator-(uint_x4<U, V> const&);

	template<typename U, typename V>
	friend bitcount_t flog2(uint_x4<U, V> const&);

	template<typename U, typename V>
	friend bitcount_t trailingzeros(uint_x4<U, V> const&);

	uint_x4& operator*=(uint_x4 const& rhs) {
...
template<typename U, typename V>
bitcount_t flog2(uint_x4<U, V> const& v) {
#if PCG_LITTLE_ENDIAN
...
template<typename U, typename V>
bitcount_t trailingzeros(uint_x4<U, V> const& v) {
#if PCG_LITTLE_ENDIAN
	for (uint8_t i = 0; i < 4; ++i) {
#else
	for (uint8_t i = 4; i != 0; /* dec in loop */) {
...
divmod(uint_x4<UInt, UIntX2> const& orig_dividend, uint_x4<UInt, UIntX2> const& divisor) {
...
template<typename UInt, typename UIntX2>
uint_x4<UInt, UIntX2> operator/(uint_x4<UInt, UIntX2> const& dividend, uint_x4<UInt, UIntX2> const& divisor) {
...
template<typename UInt, typename UIntX2>
uint_x4<UInt, UIntX2> operator*(uint_x4<UInt, UIntX2> const& a, uint_x4<UInt, UIntX2> const& b) {
...
template<typename UInt, typename UIntX2>
uint_x4<UInt, UIntX2> operator~(uint_x4<UInt, UIntX2> const& v) {
...
template<typename UInt, typename UIntX2>
bool operator==(uint_x4<UInt, UIntX2> const& a, uint_x4<UInt, UIntX2> const& b) {
...
template<typename UInt, typename UIntX2>
uint_x4<UInt, UIntX2> operator<<(uint_x4<UInt, UIntX2> const& v, const bitcount_t shift) {
	uint_x4<UInt, UIntX2> r = { 0U, 0U, 0U, 0U };
